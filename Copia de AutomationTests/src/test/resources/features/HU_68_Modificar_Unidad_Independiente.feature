Feature: Como usuario Quiero modificar una unidad independiente
...
#    And hace clic en Modificar unidad inpedendiente
  ...
  Scenario: 1.Información que se presenta al seleccionar el botón de modificar
    ...
    When Selecciiona el boton de modificar
  ...
  Scenario Outline: 2.Salir del formulario de Creación de Unidad Independiente
    Given  Un usuario en la página de Modificar Unidad Independiente
...
#    Given Un usuariio en la página de modificar Unidad Independiente
...
#    Given  Un usuario en la página de modificar Unidad Independientes
...
#    Given   Un usuario en la página de modificar Unidad Independiente
  ...
  Scenario Outline: 10.Validaciones que se realizan en la estructura del <campo> al seleccionar el botón guardar
    Given  Se ingresa un valor para un campo de tipo de campo
    When  Se envía la peticion al servicio web cuando se ingresa el <valor>
    Then  El sistema realiiza unas validaciones en los <campo> enviiados
